...
exclude_list = ['/lasix 20mg', '/lasix 20mgPO', '/lasix10mgiv',  '25/lasix 20mg', 'lasix 5mg', '20/balloon 12cc', '삽입/1000',]

uo = uo[~uo.uo.isin(exclude_list)]
...
uo_criteria.to_csv(data_dir + 'uo_criteria_0304.csv', encoding='cp949')
print(uo_criteria)
